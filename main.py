...
def main():
    ...
    if choice == 'HOME' :
        ...
        # Execute your app
        #st.title("Vessel Finder")
        #html(vesselfinder_html,width=1000, height=5000, scrolling=False)
        st.title("Vessel Finder & Marine Trafic")
        html(marrinetrafic_html,width=1000, height=5000, scrolling=False)
